...
- if param domain is not specified, then it will ignore param root-path, and
search parent directories for PROJECT file, take its path as working directory, and fetch
domain info from the file.
`,
